...
function setup() {
    ...
    collectable2 = new Collectible(cSpawn_x, cSpawn_y, cSprite2);
    ...
    new Platform(cloud_platform1, xbound/6, ybound/2, xbound/3),
    new Platform(cloud_platform3, xbound*5/6, ybound/2, xbound/3),
    new Platform(cloud_platform1, xbound/2, ybound/4, xbound/4),
    new Platform(cloud_platform2, xbound/2, ybound*3/4, xbound/4),
