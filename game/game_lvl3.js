var cSpawn_x = xbound/8;
var cSpawn_y = ybound/8;
...
function setup() {
    ...
    collectable3 = new Collectible(cSpawn_x, cSpawn_y, cSprite3);
    spring1 = new Link(game_player.body, collectable1.body, true);
    spring2 = new Link(collectable1.body, collectable2.body, true);
    spring3 = new Link(collectable2.body, collectable3.body);


    // BUILDS THE MAP GEOMETRY, Main difference between each page
    game_phys_objects.push(
    new Platform(cloud_platform3, xbound/3, ybound*3/4, xbound*3/4),
    new Platform(cloud_platform1, xbound*2/3, ybound/2, xbound*3/4),
    new Platform(cloud_platform2, xbound/3, ybound/4, xbound*3/4),
